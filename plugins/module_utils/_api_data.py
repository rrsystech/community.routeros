...
PATHS = {
    ...
    ('interface', 'lte'): APIData(
        unversioned=VersionedAPIData(
            ...
            primary_keys=('name',),
            fields={
                'allow-roaming': KeyInfo(default=False),
                'apn-profiles': KeyInfo(default='default'),
                'band': KeyInfo(can_disable=True, remove_value=''),
                'comment': KeyInfo(can_disable=True, remove_value=''),
                'disabled': KeyInfo(default=True),
                'modem-init': KeyInfo(can_disable=True),
                'mtu': KeyInfo(default=1500),
                'name': KeyInfo(required=True),
                'network-mode': KeyInfo(default='3g,lte'),
                'nr-band': KeyInfo(can_disable=True),
                'operator': KeyInfo(can_disable=True),
                'pin': KeyInfo(can_disable=True),
                'sms-protocol': KeyInfo(default='auto'),
                'sms-read': KeyInfo(default=False),
            },
        ),
    ),
    ('interface', 'lte', 'apn'): APIData(
        unversioned=VersionedAPIData(
            ...
            fields={
                ...
                'comment': KeyInfo(can_disable=True, remove_value=''),
                'copy-from': KeyInfo(),
                'default-route-distance': KeyInfo(default=2),
                'ip-type': KeyInfo(default='auto'),
                'ipv6-interface': KeyInfo(can_disable=True),
                'name': KeyInfo(required=True),
                'passthrough-interface': KeyInfo(can_disable=True),
                'passthrough-mac': KeyInfo(can_disable=True),
                'passthrough-subnet-size': KeyInfo(can_disable=True),
                'password': KeyInfo(can_disable=True),
                'use-network-apn': KeyInfo(default=True),
                'use-peer-dns': KeyInfo(default=True),
                'user': KeyInfo(can_disable=True),
            }
        ),
    ),
